    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Resize(object sender, EventArgs e)
        {
            if (GbxContent_Container != null && controller != null)
            {
                ...
                // Center the LoginController within the GroupBox
                controller.Location = new Point(
                    GbxContent_Container.Width / 2 - controller.Width / 2,
                    GbxContent_Container.Height / 2 - controller.Height / 2
                );
            }
        }
    }
